...
\begin{tikzpicture}
    ...
    \draw[fill] (0.3cm,0.7cm) circle (0.01cm) node[anchor=north,transform shape,scale=0.3]{B};
    \draw[fill] (0.6cm,0.4cm) circle (0.01cm) node[anchor=north,transform shape,scale=0.3]{C};
    ...
    \draw[line width=0.05mm] (0.5cm,1.0cm) -- (0.5cm,0.0cm);
    \draw[line width=0.05mm] (0.0cm,0.7cm) -- (0.5cm,0.7cm);
    \draw[line width=0.05mm] (0.5cm,0.4cm) -- (1.0cm,0.4cm);
    \draw[line width=0.05mm] (0.25cm,0.7cm) -- (0.25cm,0.0cm);
    \draw[line width=0.05mm] (0.9cm,1.0cm) -- (0.9cm,0.4cm);
    \draw[line width=0.05mm] (0.2cm,0.7cm) -- (0.2cm,1.0cm);
    \draw[line width=0.05mm] (0.8cm,0.4cm) -- (0.8cm,0.0cm);
